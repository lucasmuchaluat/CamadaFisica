...
def check (original, recebida):
 ...
 #=======================================================
def head (payload, total_of_packages, current_package, type_msg, server_id):
  txLen = len(payload)
...
#         	tipo*1			server_id*1  	size*1     + current package*3     + total packages*3       + response byte*2 = 10 bytes
